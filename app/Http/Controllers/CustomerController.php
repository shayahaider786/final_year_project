    ...
    public function update(Request $request)
{
    ...
    $request->validate([
        ...
        'video' => 'file|mimetypes:video/mp4', // Video validation
    ...
    if ($request->hasFile('video')) {
        ...
        $customer->video()->save($video); // Use relationship method to save video
    }

    // Update public visibility of the video
    if ($customer->video) {
        $customer->video->is_public = $request->has('public_videos');
        $customer->video->save();
    }
