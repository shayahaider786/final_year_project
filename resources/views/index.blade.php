...
@section('content')
    ...
    <div class="container ">
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="box ">
            <div class="img-box">
              <img src="backend/asset/images/s1.png" alt="">
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box ">
            <div class="img-box">
              <img src="backend/asset/images/s2.png" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Dedicated Hosting
        ...
        <div class="col-md-6 col-lg-4 ">
          <div class="box ">
            <div class="img-box">
              <img src="backend/asset/images/s3.png" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Cloud Hosting
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box ">
            <div class="img-box">
              <img src="backend/asset/images/s4.png" alt="">
            </div>
            <div class="detail-box">
              <h4>
                VPS Hosting
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box ">
            <div class="img-box">
              <img src="backend/asset/images/s5.png" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Wordpress Hosting
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box ">
            <div class="img-box">
              <img src="backend/asset/images/s6.png" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Domain Name
  ...
  <section class="about_section layout_padding-bottom" id="about">
    <div class="container  ">
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="backend/asset/images/about-img.png" alt="">
          </div>
        </div>
  ...
  <section class="server_section">
    <div class="container ">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="backend/asset/images/server-img.jpg" alt="">
            <div class="play_btn">
              <button>
  ...
  <section class="price_section layout_padding" id="prices">
    <div class="container">
      <div class="heading_container heading_center">
        <h2>
          Our Pricing
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-10 mx-auto">
                  <div class="box">
                    <div class="img-box">
                      <img src="backend/asset/images/client.jpg" alt="">
                    </div>
                    <div class="detail-box">
          ...
          <div class="info_link_box">
            ...
            <div class="info_links">
              <a class="active" href="index.html">
                <img src="backend/asset/images/nav-bullet.png" alt="">
                Home
              </a>
