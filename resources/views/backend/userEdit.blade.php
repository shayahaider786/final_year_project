...
@section('content')
    <div class="container">
        ...
        @endif
        <form id="customerForm" action="{{ route('user.update', ['customer' => $customer->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row mt-5">  
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <input type="text" name="name" value="{{ $customer->user->name }}" class="form-control" id="textInput" placeholder="Enter text">
                                                </div>
